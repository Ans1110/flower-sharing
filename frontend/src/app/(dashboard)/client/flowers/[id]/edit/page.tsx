interface FlowerEditProps {
  params: Promise<{
    id: string;
  }>;
}

export default async function FlowerEdit({ params }: FlowerEditProps) {
  const { id } = await params;

  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Edit Flower</h1>
      <p className="mb-6 text-zinc-600 dark:text-zinc-400">
        Editing flower with ID: {id}
      </p>
