      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          <div className="mb-8">
            ...
            <h1 className="text-5xl md:text-7xl font-bold bg-linear-to-r from-rose-600 via-pink-600 to-purple-600 bg-clip-text text-transparent mb-6 leading-tight pb-2">
              Flower Sharing
            </h1>
